            ...
            <form method="POST" action="" class="px-6 py-6 space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-800
                ...
                <div class="flex items-center gap-3 pt-1">
                    <button
                        type="submit"
                        class="flex-1 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white
