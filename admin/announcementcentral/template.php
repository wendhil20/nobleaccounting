...
<div class="grid grid-cols-3 gap-4 mb-6">
    ...
    <label class="cursor-pointer">
        ...
        <div class="template-card border-2 border-orange-500 rounded-xl overflow-hidden transition-all"
            data-template="1">
            ...
            <div class="px-4 py-3 bg-white">
                <p class="text-xs text-gray-400">Orange header with title and body message. Best for regular company
                    updates.</p>
            </div>
        </div>
    </label>
    ...
    <label class="cursor-pointer">
        ...
        <div class="template-card border-2 border-transparent rounded-xl overflow-hidden transition-all hover:border-red-300"
            data-template="2">
            ...
            <div class="px-4 py-3 bg-white border-l-4 border-red-500">
                <p class="text-xs text-gray-400">Red alert style with urgent badge. Best for deadlines and important
                    notices.</p>
            </div>
        </div>
    </label>
    ...
    <label class="cursor-pointer">
        ...
        <div class="template-card border-2 border-transparent rounded-xl overflow-hidden transition-all hover:border-slate-400"
            data-template="3">
...
<script>
        ...
        const previews = {
            1: `
                ...
                <div class="px-5 py-4 bg-white">
                    ...
                    <p class="text-[10px] text-gray-400 mt-3">${today}</p>
                </div>`,
    ...
    fetch('<?= BASE_URL ?>/saveannouncement', {  // ← dedicated endpoint na
        method: 'POST',
        body: formData
    })
    .then(res => res.json())
